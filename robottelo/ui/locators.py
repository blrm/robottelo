...
locators = LocatorDict({
    ...
    "rhci.page_active": (
        By.XPATH, "//span[contains(.,'%s')]/../../../li[contains(@class, 'active')]"),
    ...
    "rhci.register_nodes": (By.XPATH, "//button[@id='register-nodes-button']"),
    "rhci.node_driver_select":  (By.XPATH, "//select[@id='manualDriverInput']"),
    "rhci.node_driver_dropdown_item": (By.XPATH, "//div/select/option[contains(@value, '%s')]"),
    "rhci.node_ip_address": (By.XPATH, "//input[@id='manualAddressInput']"),
    "rhci.node_ipmi_user": (By.XPATH, "//input[@id='manualUsernameInput2']"),
    "rhci.node_ipmi_pass": (By.XPATH, "//input[@id='manualPasswordInput']"),
    "rhci.node_nic_mac_address": (By.XPATH, "//input[@id='newNodeManualMacInput%s']"),
    ...
    "rhci.node_role_block": (By.XPATH, "//a[contains(@class,'role-block-storage') or contains(@class,'role-cinder')]"),
    "rhci.node_role_block_count_select": (By.XPATH, "//li[contains(@class, 'role-block-storage') or contains(@class, 'role-cinder')][contains(@class, 'role-assigned')]/select"),
