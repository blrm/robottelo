...
locators = LocatorDict({
    ...
    "rhci.node_driver_select":  (By.XPATH, "//select[@id='newNodeDriverInput']"),
    "rhci.node_driver_dropdown_item": (By.XPATH, "//div/select/option[contains(@value, '%s')]"),
    "rhci.node_ip_address": (By.XPATH, "//input[@id='newNodeIpAddressInput']"),
    "rhci.node_ipmi_user": (By.XPATH, "//input[@id='newNodeIpmiUserInput']"),
    "rhci.node_ipmi_pass": (By.XPATH, "//input[@id='newNodePasswordInput']"),
