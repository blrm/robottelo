...
locators = LocatorDict({
    ...
    "rhci.node_flavor_count": (By.XPATH, "//h4[contains(@class, 'node-profile-free-nodes') and contains(., '2')]"),
    ...
    "rhci.node_role_controller_dropdown_item": (By.XPATH, "//li[contains(@class, 'role-controller') and contains(@class, 'role-assigned')]/select/option[. = '1']"),
    ...
    "rhci.node_role_compute_dropdown_item": (By.XPATH, "//li[contains(@class, 'role-compute') and contains(@class, 'role-assigned')]/select/option[. = '1']"),
